...
type RestaurantServiceClient interface {
	AcceptOrder(ctx context.Context, in *OrderProtos.OrderResponse, opts ...grpc.CallOption) (*OrderProtos.OrderResponse, error)
}
...
func (c *restaurantServiceClient) AcceptOrder(ctx context.Context, in *OrderProtos.OrderResponse, opts ...grpc.CallOption) (*OrderProtos.OrderResponse, error) {
	out := new(OrderProtos.OrderResponse)
	err := c.cc.Invoke(ctx, "/RestaurantService/AcceptOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RestaurantServiceServer interface {
	AcceptOrder(context.Context, *OrderProtos.OrderResponse) (*OrderProtos.OrderResponse, error)
...
func (UnimplementedRestaurantServiceServer) AcceptOrder(context.Context, *OrderProtos.OrderResponse) (*OrderProtos.OrderResponse, error) {
...
func _RestaurantService_AcceptOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OrderProtos.OrderResponse)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RestaurantServiceServer).AcceptOrder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/RestaurantService/AcceptOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RestaurantServiceServer).AcceptOrder(ctx, req.(*OrderProtos.OrderResponse))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _RestaurantService_AcceptOrder_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "Protos/RestaurantProtos/RestaurantProtos.proto",
}
